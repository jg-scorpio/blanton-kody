...
txt = open("/home/user/Desktop/Test/count.txt","r")
count = txt.read()
count = int(count)
txt.close()
...
os.mkdir(name)
os.system("chmod -R 777 /home/user/Desktop")
shutil.copy("testing.py", name)
    #os.system("python3 name/testing.py")

count += 1
count = str(count)
txt = open("/home/user/Desktop/Test/count.txt","w")
txt.write(count)
txt.close()
